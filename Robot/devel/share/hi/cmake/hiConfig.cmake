...
if("TRUE" STREQUAL "TRUE")
  set(hi_SOURCE_PREFIX /home/rosp/robot/src/hi)
  set(hi_DEVEL_PREFIX /home/rosp/robot/devel)
  set(hi_INSTALL_PREFIX "")
  set(hi_PREFIX ${hi_DEVEL_PREFIX})
else()
  set(hi_SOURCE_PREFIX "")
  set(hi_DEVEL_PREFIX "")
  set(hi_INSTALL_PREFIX /home/rosp/robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosp/robot/src/hi/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hi_NUM_DUMMY_TARGETS)
      set(hi_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hi::wrapped-linker-option${hi_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hi_NUM_DUMMY_TARGETS "${hi_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hi::wrapped-linker-option${hi_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hi_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rosp/robot/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(hi_EXPORTED_TARGETS ${${hi_dep}_EXPORTED_TARGETS})
endforeach()
